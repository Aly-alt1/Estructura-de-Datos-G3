...
public class AlumnoVector {
    ...
    public static int obtenerTamanio (){
        return Integer.parseInt (JOptionPane.showInputDialog ("Introduce el número de Alumos a registrar"));
    }
    ...
    public static void operaciones ( Alumno [] alumnos) {
        ...
        do {
            ...
            switch (opcion) {
                case "1":
                    //Llenar Arreglo break;
                case "2":
                    //Imprimir Arreglo break;
                case "3":
                    //Salir JOptionPane.showMessageDialog(null, "Bye");
                    sentinel = false;
                    break;
                default:
                    JOptionPane.showMessageDialog(null, "Opción no Valida");
            } //cierra switch }while(sentinel);
        } while (sentinel);
    }
    ...
    public static void llenarArreglo (Alumno [] alumnos){
        ...
        while(i<alumnos.length){
            ...
            alumno.setNombre(
                    JOptionPane.showInputDialog ("Introduce el Nombre del Alumno [ " + i + " ]"));
            alumno.setEdad(Integer.parseInt (JOptionPane.showInputDialog ("Introduce la edad del Alumno [ " + i + " ]")));
            alumno.setSexo(
                    JOptionPane.showInputDialog ("Introduce la edad del Alumno [ " + i + " ]").charAt(0));
            activo = JOptionPane.showInputDialog ("Introduce el estatus Alumno [ " + i + " ] Activo/Inactivo" )
